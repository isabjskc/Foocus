...
| --- | --- | --- | --- | --- | --- |
| General | run.bat |  | [juggernautXL v6_RunDiffusion](https://civitai.com/api/download/models/272376?type=Model&format=SafeTensor&size=pruned&fp=fp16) | not used | [here](https://github.com/lllyasviel/Fooocus/blob/main/modules/path.py) |
